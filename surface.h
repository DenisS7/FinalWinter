...
namespace GameSpace
{
    ...
    using Pixel = unsigned int; // unsigned int is assumed to be 32-bit, which seems a safe assumption.
    ...
    public:
        ...
        ~Sprite();
        // Methods
        void SetFile(char* a_File, unsigned int a_NumFrames, unsigned int a_CurrentFrame);
