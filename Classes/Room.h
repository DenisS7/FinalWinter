...
namespace Map
{
    ...
    public:
        ...
        void setTileMap(const newmath::ivec2 newSize, const std::vector<tile> newTileMap)
        {
            size = newSize;
        ...
        void spawnGifts();
        void readRoomLayout(std::vector<int> collisionTiles, std::vector<int> portalTiles);
        void restart();
        void initiateRoom(int number, MapManager* newManager, GameSpace::Surface* newScreen);
