...
{
public:
    Spritesheet(GameSpace::Surface* newImage, int row, int column, GameSpace::Sprite* newSprite);
    ~Spritesheet();

    void changeSpritesheet(GameSpace::Surface* newImage, int row, int column, int newCurrentRow, GameSpace::Sprite* newSprite);
