...
public:
	...
	static int isOverlapping(CollisionComponent actorCollision, GameSpace::vec2 actorPosition, Map::Room* currentRoom, int damage, int damageType, GameSpace::Surface* screen);
