...
public:
    ...
    Arrow(GameSpace::vec2 newLocf, Map::Room* newRoom, int newDirection, GameSpace::vec2 newDestination, WeaponBase* newCrossbow, char* spritePath, newmath::Rect arrowCol) :
